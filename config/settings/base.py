...
ROOT_DIR = environ.Path(__file__) - 3  # (scholariumat/config/settings/base.py - 3 = scholariumat/)
APPS_DIR = ROOT_DIR.path('scholariumat')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///scholariumat'),
}
...
MIGRATION_MODULES = {
    'sites': 'scholariumat.contrib.sites.migrations'
}
...
MIDDLEWARE = [
    ...
    'products.middleware.AddToCartMiddleware',
]
...
ADMINS = [
    ("""Merlin Buczek""", 'mb@scholarium.at'),
]
